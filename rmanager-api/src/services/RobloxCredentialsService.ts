...
import { roblox_credentials } from "@rmanager/shared/db/schema";
import {
  DecryptString256,
  EncryptString256,
} from "@rmanager/shared/lib/crypto/aes";
import {
...
export const RobloxCredentialsService = {
  // Internal Methods
  async _introspectKey(key: string): Promise<IntrospectionResult> {
